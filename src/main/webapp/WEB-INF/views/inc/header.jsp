...
<body>
        ...
        <div nid="top1" class="top1">
            ...
            <div class="wrapper">
                ...
                <div class="right">
					...
					<a href="${path }/member/join.do" class="item">회원가입</a>
					</c:if>
					<c:if test="${!empty sid }">
					<h1 class="item point">${sid }님</h1>
					<a href="${path }/member/logout.do" class="item">로그아웃</a>
						<c:if test="${sid=='admin' }">
						<a href="${path1 }/member/list.do" class="item">회원목록</a>
						</c:if>
					</c:if>
                </div>
            </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js" no-export=""></script>
    <script src="https://html2canvas.hertzen.com/dist/html2canvas.min.js" no-export=""></script>
    <script src="/js/page.js" no-export=""></script>
</body>
</html>